const OPPONENT_HEIGHT = 5,
    ...
    OPPONENT_PICTURE_DEAD = "assets/explosion.gif",
    OPPONENT_SPEED = 5,
    OPPONENT_WIDTH = 5,
    ...
    PLAYER_PICTURE_DEAD = "assets/explosion.gif",
    PLAYER_SPEED = 20,
    PLAYER_WIDTH = 5,
    SHOT_HEIGHT = 1.5,
    SHOT_SPEED = 20,
    SHOT_PICTURE_PLAYER = "assets/shot2.png",
    SHOT_PICTURE_OPPONENT = "assets/shot1.png",
    SHOT_WIDTH = 1.5
    BOSS_PICTURE = "assets/jefe.png",
    BOSS_HEIGHT = 10,
    BOSS_PICTURE_DEAD = "assets/explosion.gif",
    BOSS_SPEED = 10,
    BOSS_WIDTH = 10;
